...
_MODULES_TO_REGISTER: tuple[str, ...] = (
    ...
    "common.callbacks.wsm_pseudo_scale_warmup_callback",
    ...
    "fusion.models.av_audio_first_zero_residual",
    "fusion.models.av_audio_query_temporal_video",
    ...
    "fusion.loss.r3_aux_agreement_loss",
